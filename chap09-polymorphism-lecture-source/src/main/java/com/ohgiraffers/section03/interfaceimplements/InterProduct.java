...
public interface InterProduct /*extends java.io.Serializable, java.util.Comparator*/{
    ...
    /*
    * 인터페이스가 인터페이스를 상속받을 시에는 extends 키워드를 이용해 여러 인터페이스를 다중 상속 받을 수 있다.
    * */
    ...
    * */
    ...
    int MIN_NUM = 10; //앞에 묵시적으로 public static final이 붙어 있음
    ...
    /*
    * 인스턴스 안에 작성한 메서드는 묵시적으로 public abstract의 의미를 가진다. (다른 접근제한자 사용불가)
    * => 인터페이스의 메소드를 오버라이딩하는 경우 반드시 접근제한자를 public으로 해야 오버라이딩이 가능하다.
    * */
