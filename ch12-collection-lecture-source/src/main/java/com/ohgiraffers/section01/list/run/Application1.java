...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 자바에서 컬렉션 프레임워크는 여러 개의 다양한 데이터들을 쉽고 효과적으로 처리할 수 있도록 표준화된 방법을 제공하는 클래스들의 집합이다.
        * -> 데이터를 효율적으로 저장하는 자료구조와 데이터를 처리하는 알고리즘을 미리 구현해놓은 클래스
        * */

        /*
        * collection Frameworkd는 크게 3가지 인터페이스 중 한 가지를 상속 받아 구현해 두었다.
        * 1. List 인터페이스
        * 2. Set 인터페이스
        * 3. Map 인터페이스
        *
        ...
        * */
        ...
        /*
        * ArrayList
        * -> 배열의 단점을 보완하기 위해 만들어진다.
        * 배열의 단점 : 크기 변경 불가, 요소의 추가, 수정, 삭제, 정렬 복잡함
        * 크기 변경(새로운 더 큰 배열 만들고 옮기기), 요소의 추가, 수정, 삭제, 정렬 기능을 미리 메소드로 구현해서 제공한다.
        * */
        ArrayList<Object> alist = new ArrayList();

        /*
        * 다형성을 적용해 상위 레퍼런스로 ArrayList 객체를 만들 수 잇다.
        * List 인터페이스 하위의 다양한 구현체들로 타입 변경이 가능하기 때문에 레퍼런스 타입은 List로 해두는 게 더 유연한 코드를 작성 가능하다.
        * */

        List<Object> list = new ArrayList<>();
        /*
        * arrayList는 저장 순서가 유지되ㅣ며, index(순번)이 적용된다.
        ...
        * Collection 클래스를 사용 Collection 사용되는 기능을 static 메서드로 구현한 클래스
        * */
...
//        Collections.reverse(stringList);
        ...
        *
        * hasNext() : 다음 요소를 가지고 있는 경우 true, 더 이상 요소가 업으면 false
        * next() : 다음 요소를 반환
        *
        * */
