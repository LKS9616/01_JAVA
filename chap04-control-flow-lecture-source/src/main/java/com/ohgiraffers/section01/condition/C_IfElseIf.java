...
public class C_IfElseIf {
    ...
    * } else {
    *   // 조건식1이 false이고 조건식2가 false일 때 실행할 명령문
    * }
    *
    * if-else-if문은 조건식1의 결과 값이 참(true)이면 if{}안에 있는 코드를 실행하고, 조건식1이 false이면 조건식2를 확인하여 참(true)이명 else if {}
    * 안에 있는 코드를 실행한다. 조건식1과 조건식2가 결과값이 모두 거짓(false)이면 else {}안에 있는 코드를 실행한다.
     */
    ...
    public void testSimpleIfElseIfStatement() {
        ...
        int answer = sc.nextInt(); //1, 2, 3 중에 받아준다.
        if (answer == 1) {
...
//        }
    ...
    public void testTest () {
        ...
        System.out.println("학생의 이름은 " + name + "이며, 점수는 " + point + "이고, 등급은 " + grade + "입니다.");
    }
