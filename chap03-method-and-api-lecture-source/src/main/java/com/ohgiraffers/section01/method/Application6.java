...
public class Application6 {
    public static void main (String[] args) {
         ...
         * 반환값이 없을 때는 return을 컴파일러가 자동으로 생성했지만 반환값이 있을 때는 return 구분을 반드시 명시적으로 작성해야 한다.
         * 메소드의 선언부에 명시한 리턴 타입과, 반환값 자료형은 반드시 일치해야 한다.
         */

        Application6 app6 = new Application6();
        String returnTest = app6.testMethod();

        System.out.println(returnTest); //저장하지 않고 바로 출력이 가능하다.
    }
