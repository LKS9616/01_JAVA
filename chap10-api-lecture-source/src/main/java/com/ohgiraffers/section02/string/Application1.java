    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        for(int i = 0; i < stri.length(); i++){
            System.out.println("charat(" + i + ") = " + stri.charAt(i));
        }

        /*
        * compareTo() : 인자로 전달된 문자열과 사전 순으로 비교하여 두 문자열이 같다면 0을 반환하고 인자로 전달된 문자열보다 작으면 음수를, 크면 양수를 반환
        * 대소문자를 구분하여 비교함.
        * */
        ...
        /*
        * concat(): 문자열에 인자로 전달된 문자열을 합치기 해서 새로운 문자열을 반환
        * 원본 문자열에는 영향을 주지 않는다.
        * */
        ...
        * */
        ...
        System.out.println("빈 문자열 : " + "".length());
