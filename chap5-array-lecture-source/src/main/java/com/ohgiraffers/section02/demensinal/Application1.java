...
public class Application1 {
    public static void main(String[] args) {
         ...
         * ->2차원 배열은 1차원 배열 여러 개를 하나로 묶여서 관리하는 배열을 의미한다.
         * */
        ...
        // arr2 = new int [][2];
        arr = new int[3][]; // 주소를 묶어서 관리할 배열의 크기를 지정해야 함.
        ...
        // 크기 할당 후에, 아무 값을 대입하지 않아도, heap 영역에는 값이 없는 상태로 공간 생성이 불가능하기 때문에 기본값이 들어있다.
