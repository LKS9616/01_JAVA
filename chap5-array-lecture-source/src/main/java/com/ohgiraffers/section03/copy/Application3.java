...
public class Application3 {
    public static void main(String [] args) {
        ...
        * 깊은 복사
        *
        * 깊은 복사는 heap에 생성된 배열이 가지고 있는 값을 또 다른 배열에 복사를 해놓은 것
        * 서로 같은 값을 가지고 있지만, 두 배열 서로 다른 배열이기에 하나의 배열에 값을 변경을 하더라도 다른 배열에는 영향을 주지 않는다.
        * */

        /*
        * 깊은 복사 방법 4가지
        *
        * 1. for ansdmf dldydgks ehddlfgks dlseprtmdml rkqt qhrtk
        ...
        * */
        ...
        print(copyArr4); // 복사한 만큼의 값은 같지만 복사한 만큼의 값은 같지만, 길이도 다르고, 주소도 다르다.
