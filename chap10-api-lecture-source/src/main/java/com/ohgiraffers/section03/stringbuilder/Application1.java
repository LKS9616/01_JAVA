...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *           하지만, 변하지 않는 문자열을 자주 읽어들이는 경우 오히려 더 좋은 성능을 낸다.
        *
        * StringBuilder : 가변이라는 특징을 갖는다.
        *                 문자열에 append() 메소드를 이용해 합치는 경우 기존 인스턴스를 수정하기 때문에 새로운 인스턴스를 만들지 않는다.
        ...
        *                 스레드 동기화 처리를 고려하지 않는 상황에서 StringBuffer보다 성능이 빠르다.
        *
        ...
        * */
        ...
        /*
        * hashCode는 오버라이딩 안 되어 있음.
        * => 동일한 값을 가지는 경우 같은 해쉬코드를 반환하는 것이 아니라, 인스턴스가 동일해야 같은 해쉬코드를 반환한다.
        * */
