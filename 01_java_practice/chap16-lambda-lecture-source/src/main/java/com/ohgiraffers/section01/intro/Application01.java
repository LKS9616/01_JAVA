...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        * 또한, 매개변수가 한 개만 존재하는 경우 ()을 생략할 수 있으며, 실행문이 한 줄인 경우 {}은 생략 가능하다.
        * */

        /*
        * 인터페이스에 정의된 추상메소드를 활용하는 방법 3가지
        * 1. 인터페이스를 상속받은 클래스를 정의하여 기능을 완성 후, 사용하는 방법
        * 2. 익명 클래스를 활용하여 메소드 정의 후 사용하는 방법
        * 3. 람다식을 활용하는 방법
        * */

        // 1. 인터페이스를 구현한 구현제 이용한 방식
        Calculator c1 = new CalculatorImpl();

        System.out.println("10과 20의 합은? : " + c1.sumTwoNumber(1110, 20));
        ...
        System.out.println("a와 b의 합은? : " + c3.sumTwoNumber(40, 50));
