...
public class Application01 {
    public static void main(String[] args) {
        /*
        * 표준 함수적 인터페이스
        * JDK 8 자주 사용하는 함수적 인터페이스를 표준 API로 제공하고 있다.
        ...
        * */
        ...
        /* Consumer<T> # accept(T t) : void : 객체 T를 많이 소비 */
        ...
        ObjIntConsumer<java.util.Random> objIntConsumer =
                (random, value) -> System.out.println("0부터 " + value + "까지의 난수 발생 " + random.nextInt(value));
        ...
        /* ObjDobleConsumer<T>#accept(T t) : void : 객체 T와 double 값을 받아 소비한다. */
