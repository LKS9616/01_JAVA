...
public class MemberDTO {
    ...
    * Setter(설정자) 작성 규칙
    * : 필드값을 변경할 목적의 매개변수를 변경하려는 필드의 값은 자료형으로 선언하고 호출 당시 전달되는 매개변수의 값을 이용하여 필드의 값을 변경한다.
    * [표현식]
    ...
    *   필드에서 접근해서 기록한 값을 return을 이용하여 반환하며, 이 때 반환 타입은 반환하려는 값의 자료형과 일치시킨다.
    *
    * [표현식]
    * public 반환형 get필드명() {
    *   return 반환값;
