...
//    int hp; // 몬스터 체력
    ...
    // 0보다 작은 경우 0으로 변경할 수 있도록 기능이 필요!
    ...
    public void setHp(int hp) {
        ...
        // 지역변수는 해당 지역변수를 우선시하는 변수, hp = hp;일 시 hp가 회색으로 활성화되지 않음
        /*
        * this는 인스턴스가 생성되었을 때 자신의 주소를 저장하는 레퍼런스 변수이다.
        * 지역변수와 전역변수의 이름이 동일한 경우 지역변수를 우선적으로 접근하기 때문에 전역변수에 접근하기 위해서 this.를 명시하여야 한다.
        * */
