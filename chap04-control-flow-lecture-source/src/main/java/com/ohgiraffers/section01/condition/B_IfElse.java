...
public class B_IfElse {
   ...
   * }
   *
   * if문은 조건식의 결과 값이 참(true)이면 if {}안의 코드를 실행하고 조건식의 결과 값이 거짓(false)이면 else {}안에 있는 코드를 실행한다.
   */
  ...
  public void testSimpleIfElseStatement () {
    ...
    //홀수가 아니면 "입력받은 숫자는 짝수입니다."라고 출력하는 코드를 작성해보자.
    if (num % 2 == 1) {
  ...
  public void testNestedIfElseStatement() {
    ...
    // 조건에 상관 없이 프로그램이 종료될 때 "프로그램을 종료합니다"라고 출력되도록 한다.
    System.out.println("프로그램을 종료합니다");
  } }
