...
public class Application2 {
    public static void main(String[] args)  {
        ...
        // 문자와 문자의 연산
        // 문자는 내부적으로 숫자로 인식되어 연산된다.(아스키 코드)
        ...
        * */
        ...
        // 문자열과 다른 형태의 값 연산
        // 문자열은 무엇과 합쳐도 합친 형태로 나옴
        System.out.println("========== 문자열과 다른 형태의 값 연산 ==========");
        System.out.println("lky" + 123);
        System.out.println("lky" + 123.456);
        System.out.println("lky" + 'a');
        System.out.println("lky" + true);
